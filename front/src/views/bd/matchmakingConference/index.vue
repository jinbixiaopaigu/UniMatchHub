            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="活动标题" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="content">
                        <Input type="text" v-model="searchForm.content" placeholder="活动内容" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="address">
                        <Input type="text" v-model="searchForm.address" placeholder="活动地点" clearable style="width: 150px" />
                    </Form-item>
...
<script>
import {
    getMatchmakingConferenceList,
    deleteMatchmakingConference
} from "./api.js";
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getMatchmakingConferenceList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
